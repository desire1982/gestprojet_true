...
if (!isset($_SESSION["access"])) {
    ...
    try {
        ...
        $sql = "SELECT mod_modulegroupcode, mod_modulegroupname FROM tbl_module "
        ...
        $sql = "SELECT mod_modulegroupcode, mod_modulegroupname, mod_modulepagename,  mod_modulecode, mod_modulename FROM tbl_module "
                . " WHERE 1 "
                . " ORDER BY `mod_modulegrouporder` ASC, `mod_moduleorder` ASC  ";
        ...
        $sql = "SELECT rr_modulecode, rr_create,  rr_edit, rr_delete, rr_view FROM tbl_role_rights "
