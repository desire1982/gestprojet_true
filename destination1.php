        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="panel panel-default" id="tableau1">
                        <div class="panel-heading">
                        
                        <form role="form" method="post" id="formdestination" action="affichedestination.php">
                            Gestion des destinations
                              <div class="pull-right">  <button type="submit" name="enregistrer" id="enregistrer" class="btn btn-default">ENREGISTRER</button> <button type="submit" name="nouveau" id="nouveau" class="btn btn-default">NOUVEAU</button>  <button type="reset" class="btn btn-default" id="supprimer">SUPPRIMER</button></div>
                        </div>
                        ...
                        <!-- /.panel-body -->
                         ...
                         <!-- /.2emepanel-body -->
                        <div class="panel panel-default" id="destinationcache">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            <label>Destination2</label>
                                            <input class="form-control" name="destination" id="destination" placeholder="Entrer la destination">
                                           
                                        </div>
                                        <div class="form-group">
                                            <label>Libelle2</label>
                                            <input class="form-control" name="lib_destination" id="lib_destination" placeholder="Entrez le libelle">
                                        </div>
...
$('#nouveauN').click(function(){
	...
	$('#enregistrer').click(function(){
		...
		if(destination=="" || lib_destination =="" ){
	       $('#enregistrer').show();
		$('#formulmaireresultat').html('Veuillez renseigner tous les champs').show(1500).delay(2500).hide(200);
		return false;	
		}else{
