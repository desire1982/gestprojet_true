...
<div class="radio" style="text-align:center">
  ...
  <input type="radio" name="rech_notification" id="notif_credit" value="notif_credit">Notification
</label>
<label class="radio-inline">
  <input type="radio" name="rech_notification" id="notif_credit" value="notif_arete"> arete
</label>
</div>
<P></P>
...
$.ajax({
	type:'POST',
	url:"php/rech_notif_budgetaire.php",
