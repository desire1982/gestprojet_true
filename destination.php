...
<div class="alert alert-danger alert-dismissible" role="alert">
  <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
  <strong>Erreur </strong> Echec <?php echo $stmt->error; ?>
</div>
<?php
	 }
	// fin de si de insertion
     ...
     <span class='glyphicon glyphicon-info-sign'></span> &nbsp; la destination existe déjà !
    </div>"; 
		  
		  
		  } // fin de si de verification de destination du count
	 $mysqli->close();
  } else{
...
<div class='alert alert-warning alert-dismissible' role='alert'>
  <button type='button' class='close' data-dismiss='alert'><span aria-hidden='true'>×</span><span class='sr-only'>Close</span></button>
  <strong>Tous les Champs</strong> sont vides.
</div>";
...
<body>
  ...
  ?>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" id="tableau1">
                            <div class="row">
                                <div class="col-lg-6">
