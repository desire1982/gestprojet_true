<?php
$mysqli = new mysqli("localhost", "root", "", "gestprojet");
...
<html lang="en">
  ...
  <div class="container">
    ...
    <div class="panel panel-default" style="width:50%; padding-left: 40px; padding-right:40px; margin-left:auto; margin-right:auto;" >
 ...
 <?php $res_menu = $mysqli->query("SELECT statut FROM tbl_user");
